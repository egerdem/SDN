        ...
        app.layout = html.Div([
            ...
            html.Div([
                ...
                html.Div([
                    ...
                    html.Div([
                        html.H4("Time Range:", style={'display': 'inline-block', 'marginRight': '15px', 'color': dark_theme['text'], 'fontSize': '0.9em'}),  # Make text smaller
                        dcc.RadioItems(
                            ...
                            value=0.05,
                            labelStyle={'display': 'inline-block', 'marginRight': '20px', 'cursor': 'pointer', 'fontSize': '0.9em'},  # Make text smaller
                        ...
                        html.Div([
                            dcc.RadioItems(
                                ...
                                value='monitor',
                                labelStyle={'display': 'inline-block', 'marginRight': '10px', 'cursor': 'pointer', 'fontSize': '0.9em'},  # Make text smaller
                                style={'color': dark_theme['text']},
                                inputStyle={'marginRight': '5px'}
                            )
                        ], style={'position': 'absolute', 'right': '20px', 'top': '5px'})  # Position in top right
                    ], style={'margin': '5px 0 0 20px', 'display': 'flex', 'alignItems': 'center', 'position': 'relative'}),  # Add relative positioning
                    ...
                    html.Div([
                        html.H3("Active Experiments", 
                               style={'textAlign': 'center', 'marginTop': '10px', 'marginBottom': '5px', 'color': dark_theme['text']}),
                        ...
                        html.Div([
                            ...
                            ], style={'flex': '1', 'marginLeft': '10px', 'display': 'flex', 'flexDirection': 'column', 'justifyContent': 'flex-start'})
                ...
                html.Div([
                    html.H3(
                        # "Room Layout (Top View)", 
                           style={'textAlign': 'left', 'marginBottom': '5px', 'marginTop': '60px', 'color': dark_theme['text']}),
                    ...
                    for idx, exp in enumerate(sorted_experiments, 1):
                        ...
                        for rec_idx in receiver_indices:
                            try:
                                ...
                                if reference_id not in pos_exp_by_label or exp.get_label()['label_for_legend'] not in pos_exp_by_label:
                                    continue
                                ...
                                if comparison_type == 'edc':
                                    ...
                                    # Calculate full smoothed energy once
                                    sig1_full = self.an.calculate_smoothed_energy(pos_ref.rir, window_length=30, Fs=pos_ref.fs)
                                    sig2_full = self.an.calculate_smoothed_energy(pos_exp.rir, window_length=30, Fs=pos_exp.fs)
