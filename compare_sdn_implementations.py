...
def plot_rir_comparison(rirs, labels=None, PLOT_EDC=False, Fs=44100, duration=None, room_dim=None, absorption=None):
...
if __name__ == "__main__":
    ...
    CALC_ISM = True  # Calculate ISM implementation
    PRINT_TIMING = True  # Print timing information
    PLOT_EDC = False  # Plot energy decay curves
    PLOT_FREQ = True  # Plot frequency response
    # Run comparison
    duration = 0.05
