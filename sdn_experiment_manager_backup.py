...
class SDNExperimentManager:
    ...
    def run_experiment(self, config, room_parameters, duration=0.5, fs=44100, force_rerun=False, room_name=None,
                       method='SDN'):
        """
        ...
        Args:
            ...
            room_name (str, optional): Explicit name for the room (e.g. 'room_aes'). If None, a hash will be generated.
        ...
        if method == 'SDN':
            ...
            source_loc = np.array(
                [room_parameters['source x'], room_parameters['source y'], room_parameters['source z']])
    ...
    def plot(self, room_name=None):
        ...
        app.layout = html.Div([
            ...
            html.Div([
                # Left side - plots and table (75% width)
                html.Div([
                    # Time range selector
                    html.Div([
                        html.H4("Time Range:",
                ...
                html.Div([
                    ...
                    html.Div([
                        html.H3("Room Layout (Top View)",
                                style={'textAlign': 'center', 'marginBottom': '5px', 'marginTop': '65px',
                                       'color': dark_theme['text']}),

                        html.Div(id='pos-info',
                                 style={'textAlign': 'center', 'marginBottom': '5px', 'marginTop': '10px',
                                        'fontSize': '14px', 'color': dark_theme['text']}),
                    ...
                    ], style={'textAlign': 'center', 'marginTop': '5px', 'marginBottom': '10px'}),
        ...
        def update_navigation(prev_room_clicks, next_room_clicks,
            ...
            # Use new table data preparation method
            ...
            # Set dark mode styling for the room visualization
    ...
    def run_ism_experiment(self, room_parameters, max_order=12, ray_tracing=False, use_rand_ism=False, duration=0.5,
                           fs=44100, force_rerun=False, room_name=None, label="ISM"):
        """
...
if __name__ == "__main__":
    ...
    # Run another SDN experiment with different parameters
    manager.run_experiment(
        config={
            'label': 'weighted psk',
            'info': '',
